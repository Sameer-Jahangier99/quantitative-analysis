...
class HybridRetriever:
    ...
    def retrieve_dense(self, query: str, top_k: int) -> List[Tuple[str, float]]:
        ...
        # Use query_points with vector directly (correct Qdrant API)
        # The query parameter can accept a list of floats directly
...
"""
    ...
    def query(self, question: str) -> Dict:
        ...
        # Get memory usage
        cpu_mem, gpu_mem = self.metrics_monitor.get_memory_usage()
